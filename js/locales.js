...
`,
      ...
      "app-main-link": "App explanations and courses",
      "flashcards_completed": "You learned all cards in this set.",
      "sync-with-google": "Keep progress by Google login",
      ...
      "go_back": "GO BACK ",
      "recap_title": "Round Recap",
      "hint-panel": "Click to see transcr",
      "confirm_request": "Are you sure?",
      "topic_statistics_reset": "You asked to reset all words/sentences statistics for this topic.",
      "all_statistics_reset": "You asked to reset all words/sentences statistics for all topics.",
      "dismiss": "✘ Dismiss",
      "confirm": "✔ Confirm",
      "recommended-action": "Recommended action:",
      "mark-completed": "✔ Mark as completed",
      "mark-incompleted": "✘ Mark as incompleted",
      "sum-repeat": " REPEAT",
      "sum-next": "NEXT ",
...
`,
      ...
      "app-main-link": "Документация и другие курсы",
      "sync-with-google": "Сохранять настройки в Google",
      ...
      "topic_statistics_reset": "Вы запросили сброс всех статистик слов/предложений для этой темы.",
      "all_statistics_reset": "Вы запросили сброс всех статистик слов/предложений для всех тем.",
      "dismiss": "✘ Отмена",
      "confirm": "✔ Подтвердить",
      "recommended-action": "Рекомендуемое действие:",
      "mark-completed": "✔ Отметить как пройденное",
      "mark-incompleted": "✘ Отметить как непройденное",
